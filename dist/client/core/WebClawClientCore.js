...
exports.WebClawClientCore = void 0;
const commands_1 = require("./commands");
const help_text_1 = require("./help-text");
const provider_models_1 = require("./provider-models");
class WebClawClientCore {
    constructor(options) {
        this.client = options.transport;
        this.catalog = options.catalog ?? (0, provider_models_1.createEmptyProviderModelCatalog)();
        this.hostActions = options.hostActions;
        this.provider = (0, provider_models_1.inferProviderFromModel)(this.client.getConfig().model, this.catalog);
    }
    getTransport() {
        return this.client;
    }
    ...
    async executeInput(input) {
        ...
        const command = (0, commands_1.parseCommand)(trimmed);
        if (!command) {
            return {
                kind: 'command',
                command: 'invalid',
        ...
        switch (command.type) {
            case 'help':
                return {
                    kind: 'command',
                    command: 'help',
                    lines: [(0, help_text_1.getClientCommandHelpText)()],
                    state: this.getState(),
                };
            case 'clear':
            case 'new':
            ...
            case 'provider': {
                const provider = command.value;
                const nextModel = (0, provider_models_1.getDefaultModelForProvider)(provider, this.catalog);
...
exports.WebClawClientCore = WebClawClientCore;
//# sourceMappingURL=WebClawClientCore.js.map