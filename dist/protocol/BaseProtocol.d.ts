...
export declare abstract class BaseProtocol {
     ...
     * @returns 前端协议格式的响应
     */
    abstract format(model: string, message: Pick<InternalResponse, 'content' | 'tool_calls' | 'finish_reason'>, usage?: InternalResponse['usage']): unknown;
}
//# sourceMappingURL=BaseProtocol.d.ts.map